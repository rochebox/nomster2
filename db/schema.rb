...
ActiveRecord::Schema.define(version: 20160704195845) do
  ...
  create_table "photo2s", force: true do |t|
    t.text     "caption"
    t.integer  "place_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "photo2s", ["place_id"], name: "index_photo2s_on_place_id", using: :btree
